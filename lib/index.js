 ...
 * `dsh-agent-presets` re-reads its roots on every list, so the preset shows
 * up in the UI immediately; the symlink tracks this package's files, so
 * upgrading this plugin updates the preset in place. Uninstalling removes
